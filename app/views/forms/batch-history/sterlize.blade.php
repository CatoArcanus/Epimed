	...
	<div>
		...
		{{ Form::open (array('url' => '', 'method' => 'put', 'class' => 'form-horizontal', 'role' => 'form')) }}	
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					{{ Form::text('', 	$product->name,				array('class' => 'form-control form-inline')) }}
				</div>
				{{ Form::label('final_lot_#', 'Final Lot #:', 		array('class' => 'col-sm-2 control-label col-sm-offset-1 form-inline text-primary')) }}
				<div class="col-sm-2">
					{{ Form::text('', 	$batch->lot,				array('class' => 'form-control form-inline')) }}
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					{{ Form::text('', 	$product->alphanumeric,					array('class' => 'form-control form-inline')) }}
				</div>
				{{ Form::label('final_quantity', 'Final Quantity',	array('class' => 'col-sm-2 control-label col-sm-offset-1 form-inline text-primary')) }}
				<div class="col-sm-2">
					{{ Form::text('', 	@$batch->sterilization->quantity,			array('class' => 'form-control form-inline')) }}
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-1">
					{{ Form::text('target_burst_pressure', 	@$product->productHeatSeal->target,						array('class' => 'form-control form-inline')) }}
				</div>
				{{ Form::label('alert_limit', 'Alert Limit:',						array('class' => 'col-sm-2 control-label form-inline')) }}
				<div class="col-sm-1">
					{{ Form::text('alert_limit', 	@$product->productHeatSeal->alert,								array('class' => 'form-control form-inline')) }}
				</div>
				{{ Form::label('action_limit', 'Action Limit:',						array('class' => 'col-sm-2 control-label form-inline')) }}
				<div class="col-sm-1">
					{{ Form::text('action_limit', 	@$product->productHeatSeal->action,								array('class' => 'form-control form-inline')) }}
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-1">
					{{ Form::text('high_temp', @$machine->machineReading->value,		array('class' => 'form-control form-inline')) }}
				</div>				
				<div class="col-sm-1">
					{{ Form::text('dwell', @$machine->machineReading->value,		array('class' => 'form-control form-inline')) }}
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-1">
					{{ Form::text('pressure', @$machine->machineReading->value,		array('class' => 'form-control form-inline')) }}
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					{{ Form::text('', $generation->generator->user->username,			array('class' => 'form-control form-inline')) }}
				</div>
				{{ Form::label('sealed_by_date0', 'Date:',	array('class' => 'col-sm-1 control-label form-inline')) }}
				<div class="col-sm-2">
					{{ Form::text('sealed_by_date0', $generation->date,	array('class' => 'form-control form-inline')) }}					
				</div>
			</div>
			...
			<table class="table table-bordered">
				...
				<tbody id="dynamic_burst">
					<tr>
						...
						<td>
							{{ Form::text('inspection_rejected_heatSeal', @$Other->inspection->rejected,						array('class' => 'form-control form-inline')) }}
						</td>
						<td>
							{{ Form::text('inspection_pass_heatSeal', @$Other->inspection->pass,							array('class' => 'form-control form-inline')) }}
						</td>
						<td>
			...
			<div>
				{{ Form::textarea('', @$Other->comment->text, array('class' => 'form-control form-inline')) }}
			</div>
			...
			<div class="form-group">
				{{ Form::label('sterlize_date', 'Date Sterilized:',				array('class' => 'col-sm-1 control-label form-inline')) }}
				<div class="col-sm-2">
					{{ Form::text('sterilize_date', 	@$Other->sterilization->date,							array('class' => 'form-control form-inline')) }}
				</div>
				{{ Form::label('sterilize_sterilizer', 'Sterilizer:',				array('class' => 'col-sm-1 control-label form-inline')) }}
				<div class="col-sm-2">
					{{ Form::text('sterilize_sterilizer', 	@$Other->sterilization->sterilized_by->user->username,					array('class' => 'form-control form-inline')) }}
				</div>
				{{ Form::label('sterilize_workOrderNumber', 'Work Order Number:',array('class' => 'col-sm-2 control-label form-inline')) }}
				<div class="col-sm-2">
					{{ Form::text('sterilize_workOrderNumber', 	@$Other->sterilization->work_order,				array('class' => 'form-control form-inline')) }}
				</div>
				{{ Form::label('sterilize_quantity', 'Quantity:',				array('class' => 'col-sm-1 control-label form-inline')) }}
				<div class="col-sm-1">
					{{ Form::text('sterilize_quantity', 	@$Other->sterilization->quantity,						array('class' => 'form-control form-inline')) }}
				</div>
			</div>
