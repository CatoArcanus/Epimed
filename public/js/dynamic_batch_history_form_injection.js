...
function injectRowContent(counter, name) {
	...
	span.append(
		'<tr>\
			<td>\
				<input class="form-control form-inline" name="burst_time'+counter+'" type="text" value="">\
			</td>\
			<td>\
				<input class="form-control form-inline" readonly="" name="burst_sample_#'+counter+'" type="text" value="'+index+'">\
			</td>\
			<td>\
				<input class="form-control form-inline" name="burst_pressure'+counter+'" type="text" value="">\
			</td>\
			<td>\
				<input class="form-control form-inline" name="burst_location'+counter+'" type="text" value="">\
			</td>\
			<td>\
				<input class="form-control form-inline" name="burst_seal_transfer'+counter+'" type="text" value="">\
			</td>\
			<td>\
				<input class="form-control form-inline" name="burst_wicking'+counter+'" type="text" value="">\
			</td>\
		</tr>'
	);
